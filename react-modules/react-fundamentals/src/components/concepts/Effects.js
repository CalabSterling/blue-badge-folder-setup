        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <ul>
                    ...
                    <li>Effects can return cleanup function, which can clean up timers using memory, listeners to outside APIs, and other functions which may use system resources.</li>
                </ul>
                <SampleEffect />
                <br />
                <SampleEffect />
...
const SampleEffect = () => {
    ...
    useEffect(()=> {
        console.log('This pointing needs some happy trees');
    }, [])
